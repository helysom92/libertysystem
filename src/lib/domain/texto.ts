...
/** Normaliza texto pra busca/comparação: sem espaço nas pontas, minúsculo e sem acento —
 * "Marlao"/"marlão" e "Italo"/"Ítalo" devem casar entre si, já que o usuário nem sempre digita
 * o acento certo. */
